...
class Bing():
    ...
    async def search(self, querry, num):
        ...
        headers = {
            ...
            "cookie": f"f_EDGE_V=1; MUID={muid}; SRCHD=AF=NOFORM; MUIDV=NU=1; SRCHUID=V=2&GUID={''.join(random.choices('abcdefghijklmnopqrstuvwxyz'.upper()+'0123456789',k=32))}&dmnchg=1; SRCHHPGUSR=NRSLT=50;"
